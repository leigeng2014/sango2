...
STORAGE_CONFIG = {
    '1':{
        ...
        'mongodb':{'host':'127.0.0.1','port':27018,'db':'plaguedb','username':'plagueu','password':'W3aMi6W7Q15iUN6wcHfShC5f8'}, #一个mongodb 用来存储游戏数据
        'top_redis':{'host':'127.0.0.1','port':6379,'db':'1'},  #一个redis 用来做排行榜
        'log_mongodb':{'host':'127.0.0.1','port':27018,'db':'plaguedb','username':'plagueu','password':'W3aMi6W7Q15iUN6wcHfShC5f8'},#一个mongodb 用来日志数据存储
        'secondary_log_mongodb':{'host':'127.0.0.1','port':27018,'db':'plaguedb','username':'plagueu','password':'W3aMi6W7Q15iUN6wcHfShC5f8'},
    },
}
